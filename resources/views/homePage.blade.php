    ...
    <div class="c-wrapper c-fixed-components">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav d-md-down-none">
          ...
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{route(Route::currentRouteName(),'en')}}">English</a></li>
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{route(Route::currentRouteName(),'ar')}}">Arabic</a></li>
       </ul> 
